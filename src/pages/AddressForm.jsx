...
const AddressForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // ✅ move to payment page with address
    navigate("/payment", { state: { address } });
  };

  const inputStyle = "mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm";

  return (
    <section className="max-padd-container py-12 bg-gray-50">
      <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-6 text-center">
          Shipping Address, {user.username}
        </h2>
